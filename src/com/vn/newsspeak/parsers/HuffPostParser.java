...
public class HuffPostParser extends ArticleParser {
	
	public HuffPostParser() {
		super();
	}
	...
	protected String getContent(String link, String type) throws ParserException {
		...
		HasAttributeFilter attrFilter = new HasAttributeFilter("class", "entry_body_text");
		...
		list = list.extractAllNodesThatMatch(paraFilter);
