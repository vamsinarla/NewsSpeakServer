...
public class IndiaTodayParser extends ArticleParser {

	public IndiaTodayParser() {
		super();
	}
	...
	protected String getContent(String link, String type) throws ParserException {
		...
		String content = "";
		TagNameFilter divFilter = new TagNameFilter("p");
		HasAttributeFilter attrFilter = new HasAttributeFilter("class", "storydiv");
		...
		NodeList list = parser.parse(divFilter);
