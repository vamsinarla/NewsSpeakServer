...
public class ReadWriteWebParser extends ArticleParser {

	public ReadWriteWebParser() {
		super();
	}
	...
	protected String getContent(String link, String type) throws ParserException {
		...
		HasAttributeFilter attrFilter = new HasAttributeFilter("class", "entry-asset asset");
